...
import BenchPostsRow from "./bench_posts_table";
import BenchUsersRow from "./bench_users_table";
...
const tablesSchema = __schema({
  bench_posts: __table({
    ...
    constraints: [
      { name: 'bench_posts_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, BenchPostsRow),
  bench_users: __table({
    name: 'bench_users',
    ...
    constraints: [
      { name: 'bench_users_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, BenchUsersRow),
});
