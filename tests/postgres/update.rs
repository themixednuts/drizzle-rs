...
#[drizzle::test]
fn update_single_row(db: &mut TestDb<SimpleSchema>) {
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn update_multiple_columns(db: &mut TestDb<ComplexSchema>) {
...
#[drizzle::test]
fn update_with_placeholders_sql(db: &mut TestDb<SimpleSchema>) {
    let SimpleSchema { simple } = schema;
...
#[drizzle::test]
fn update_with_placeholders_execute(db: &mut TestDb<SimpleSchema>) {
    let SimpleSchema { simple } = schema;
