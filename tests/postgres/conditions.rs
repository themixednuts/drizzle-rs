...
#[drizzle::test]
fn condition_eq(db: &mut TestDb<SimpleSchema>) {
...
#[drizzle::test]
fn condition_neq(db: &mut TestDb<SimpleSchema>) {
    let SimpleSchema { simple } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_gt_lt(db: &mut TestDb<ComplexSchema>) {
...
#[drizzle::test]
fn condition_in_array(db: &mut TestDb<SimpleSchema>) {
    let SimpleSchema { simple } = schema;
...
#[drizzle::test]
fn condition_not_in_array(db: &mut TestDb<SimpleSchema>) {
    let SimpleSchema { simple } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_is_null(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_is_not_null(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
...
#[drizzle::test]
fn condition_like(db: &mut TestDb<SimpleSchema>) {
    let SimpleSchema { simple } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_between(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_and(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_or(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_nested_and_or(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
...
#[cfg(feature = "uuid")]
#[drizzle::test]
fn condition_not(db: &mut TestDb<ComplexSchema>) {
    let ComplexSchema { complex, .. } = schema;
