...
mod uuid_tests {
    ...
    postgres_test!(uuid_insert_and_select, PgUuidTypesSchema, {
        ...
        let results: Vec<SelectPgUuidTypes> = drizzle_exec!(stmt => all_as);
...
postgres_test!(basic_types_insert_and_select, PgBasicTypesSchema, {
    ...
    let results: Vec<SelectPgBasicTypes> = drizzle_exec!(stmt => all_as);
...
postgres_test!(optional_types_with_values, PgOptionalTypesSchema, {
    ...
    let results: Vec<SelectPgOptionalTypes> = drizzle_exec!(stmt => all_as);
    assert_eq!(results.len(), 1);
...
mod chrono_tests {
    ...
    postgres_test!(chrono_types_roundtrip, PgChronoTypesSchema, {
        ...
        let results: Vec<SelectPgChronoTypes> = drizzle_exec!(stmt => all_as);
...
mod geo_tests {
    ...
    postgres_test!(geo_point_roundtrip, PgGeoTypesSchema, {
        ...
        let results: Vec<SelectPgGeoTypes> = drizzle_exec!(stmt => all_as);
...
mod cidr_tests {
    ...
    postgres_test!(network_types_roundtrip, PgNetworkTypesSchema, {
        ...
        let results: Vec<SelectPgNetworkTypes> = drizzle_exec!(stmt => all_as);
...
mod bitvec_tests {
    ...
    postgres_test!(bitvec_roundtrip, PgBitVecTypesSchema, {
        ...
        let results: Vec<SelectPgBitVecTypes> = drizzle_exec!(stmt => all_as);
...
mod arrayvec_tests {
    ...
    postgres_test!(arrayvec_roundtrip, PgArrayVecTypesSchema, {
        ...
        let results: Vec<SelectPgArrayVecTypes> = drizzle_exec!(stmt => all_as);
...
mod json_tests {
    ...
    postgres_test!(json_custom_struct_roundtrip, PgJsonTypesSchema, {
        ...
        let results: Vec<SelectPgJsonTypes> = drizzle_exec!(stmt => all_as);
    ...
    postgres_test!(jsonb_nested_struct_roundtrip, PgJsonTypesSchema, {
        ...
        let results: Vec<SelectPgJsonbTypes> = drizzle_exec!(stmt => all_as);
