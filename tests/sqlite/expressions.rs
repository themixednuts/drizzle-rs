...
sqlite_test!(test_aggregate_functions, SimpleSchema, {
    ...
    // Test count function
    let result: Vec<CountResult> = drizzle_exec!(db
...
sqlite_test!(test_aggregate_functions_with_real_numbers, ComplexSchema, {
    ...
    let result: Vec<SumRealResult> = drizzle_exec!(db
    ...
    let result: Vec<AvgResult> = drizzle_exec!(db
    ...
    let result: Vec<MinRealResult> = drizzle_exec!(db
    ...
    let result: Vec<MaxRealResult> = drizzle_exec!(db
...
sqlite_test!(test_distinct_expression, SimpleSchema, {
    ...
    let result: Vec<DistinctResult> = drizzle_exec!(db
...
sqlite_test!(test_coalesce_expression, ComplexSchema, {
    ...
    let result: Vec<CoalesceStringResult> = drizzle_exec!(db
        .select(alias(
    ...
    let result: Vec<CoalesceIntResult> = drizzle_exec!(db
...
sqlite_test!(test_alias_expression, SimpleSchema, {
    ...
    let result: Vec<AliasResult> = drizzle_exec!(db
    ...
    let result: Vec<CountAliasResult> = drizzle_exec!(db
    ...
    let result: Vec<SumAliasResult> = drizzle_exec!(db
...
sqlite_test!(test_complex_expressions, ComplexSchema, {
    ...
    let result: Vec<ComplexAggregateResult> = drizzle_exec!(db
        .select((
    ...
    let result: Vec<CoalesceAvgResult> = drizzle_exec!(db
...
sqlite_test!(test_multiple_aliases, SimpleSchema, {
    ...
    let result: Vec<ResultRow> = drizzle_exec!(db
        .select((
...
sqlite_test!(test_cte_integration_simple, SimpleSchema, {
    ...
    let result: Vec<SelectSimple> = drizzle_exec!(db
        .with(&filtered_users)
...
sqlite_test!(test_cte_complex_two_levels, SimpleSchema, {
    ...
    let result: Vec<StatsResult> = drizzle_exec!(db
        .with(&filtered_users)
        .select((
...
sqlite_test!(test_cte_after_join, SimpleSchema, {
    ...
    let results: Vec<SelectSimple> = drizzle_exec!(db
        .with(&joined_simple)
...
sqlite_test!(test_column_arithmetic, SimpleSchema, {
    ...
    let result: Vec<ComputedResult> = drizzle_exec!(db
...
sqlite_test!(test_string_upper_lower, SimpleSchema, {
    ...
    // Test UPPER function
    let result: Vec<StringResult> = drizzle_exec!(db
...
sqlite_test!(test_string_length, SimpleSchema, {
    ...
    let result: Vec<LengthResult> = drizzle_exec!(db
...
sqlite_test!(test_string_instr, SimpleSchema, {
    ...
    let result: Vec<InstrResult> = drizzle_exec!(db
...
sqlite_test!(test_math_abs, SimpleSchema, {
    ...
    // Test ABS function
    let result: Vec<MathIntResult> = drizzle_exec!(db
...
sqlite_test!(test_math_round, SimpleSchema, {
    ...
    let result: Vec<MathFloatResult> = drizzle_exec!(db
...
sqlite_test!(test_datetime_strftime, SimpleSchema, {
    ...
    let result: Vec<DateResult> = drizzle_exec!(db
