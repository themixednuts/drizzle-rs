...
pub trait SQLSchema<'a, T, V: SQLParam + 'a> {
    const NAME: &'a str;
    const TYPE: T;
    const SQL: SQL<'a, V>;
...
pub trait SQLColumn<'a, Value: SQLParam + 'a>:
    SQLColumnInfo + Default + ToSQL<'a, Value> + SQLSchema<'a, &'a str, Value>
{
...
pub trait SQLTable<'a, Value: SQLParam + 'a>:
    SQLSchema<'a, SQLSchemaType, Value> + SQLTableInfo + Default + ToSQL<'a, Value>
{
    ...
    type Select: ToSQL<'a, Value> + SQLModel<'a, Value> + Default + 'a;
...
pub trait SQLIndex<'a, V: SQLParam + 'a>: ToSQL<'a, V> {
    /// The table type this index is associated with
    type Table: SQLTable<'a, V>;
