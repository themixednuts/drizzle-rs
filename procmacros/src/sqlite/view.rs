    ...
    let view_column_ref_literals: Vec<proc_macro2::TokenStream> = ctx
        ...
        .map(|f| {
            ...
            let flag_bits = ColumnRefFlags::new()
                ...
                .with(ColumnRefFlags::HAS_DEFAULT, f.default.is_some())
                .bits();
