// Benchmarks for rusqlite, turso, and mvcc.
// libsql runs in a separate binary (sqlite_libsql) to avoid duplicate
// sqlite3 C symbol conflicts between libsqlite3-sys and libsql-ffi.
